...
Description: A simulation that models Harmonic Oscillators and shows the difference between them being underdamped, overdamped, and critically damped. For this simulation, I will be using a mass (m) on a spring that is attached to a block/wall.
